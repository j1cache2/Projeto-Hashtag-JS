...
function desenharProdutoNoCarrinho(idProduto) {
    ...
    const cartaoProdutoCarrinho = `<button id="remover-item-${produto.id}"><i class="fa-solid fa-circle-xmark text-slate-500 absolute top-0 right-2 hover:text-slate-800"></i></button>
